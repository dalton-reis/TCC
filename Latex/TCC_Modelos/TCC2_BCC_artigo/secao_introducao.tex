...
O presente \emph{template} deve ser seguido para a confecção dos trabalhos
finais de conclusão dos cursos de Ciência da Computação da FURB. Ele é
fortemente (mas não totalmente) baseado no modelo da Sociedade Brasileira de
Computação de modo a facilitar posteriores adaptações para publicações das
produções dos TCCs em eventos científicos. O \emph{template} proposto segue as
normas da ABNT para citações e referências bibliográficas, bem como para
referências à figuras, quadros e tabelas.

Para o TCC do curso, \textbf{o presente artigo está limitado a 20
